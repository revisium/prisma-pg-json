...
describe('String Filters Integration', () => {
  ...
  it('should handle string equals', async () => {
    ...
    expect(results1.map((r) => r.id)).toEqual(['str-1']);
    ...
    expect(results2.map((r) => r.id)).toEqual(['str-5']);
  });
  ...
  it('should handle string contains', async () => {
    ...
    expect(results1.map((r) => r.id)).toEqual(['str-1', 'str-2']);
    ...
    expect(results2.map((r) => r.id)).toEqual(['str-3', 'str-4']);
  });
  ...
  it('should handle string startsWith', async () => {
    ...
    expect(results3.map((r) => r.id)).toEqual(['str-5']);
  });
  ...
  it('should handle string in array', async () => {
    ...
    expect(results.map((r) => r.id)).toEqual(['str-1', 'str-2']);
  });
  ...
  it('should handle string notIn array', async () => {
    ...
    expect(results.map((r) => r.id)).toEqual(['str-2', 'str-3', 'str-4']);
  });
  ...
  it('should handle string gt operation', async () => {
    ...
    const results = await prisma.$queryRaw<Array<{ id: string }>>(query);
    expect(results.length).toBe(2);
    expect(results.map((r) => r.id)).toEqual(['str-4', 'str-5']);
  });
  ...
  it('should handle string gte operation', async () => {
    ...
    const results = await prisma.$queryRaw<Array<{ id: string }>>(query);
    expect(results.length).toBe(3);
    expect(results.map((r) => r.id)).toEqual(['str-3', 'str-4', 'str-5']);
  });
  ...
  it('should handle string lt operation', async () => {
    ...
    const results = await prisma.$queryRaw<Array<{ id: string }>>(query);
    expect(results.length).toBe(3);
    expect(results.map((r) => r.id)).toEqual(['str-1', 'str-2', 'str-3']);
  });
  ...
  it('should handle string lte operation', async () => {
    ...
    expect(results.map((r) => r.id)).toEqual(['str-1', 'str-2', 'str-3', 'str-4']);
  });
  ...
  it('should handle string range (gt + lt)', async () => {
    ...
    expect(results.map((r) => r.id)).toEqual(['str-3']);
  });
  ...
  it('should handle string range (gte + lt)', async () => {
    ...
    const results = await prisma.$queryRaw<Array<{ id: string }>>(query);
    expect(results.length).toBe(2);
    expect(results.map((r) => r.id)).toEqual(['str-2', 'str-3']);
  });
  ...
  it('should handle string case insensitive mode', async () => {
    ...
    const results3 = await prisma.$queryRaw<Array<{ id: string }>>(query3);
    expect(results3.length).toBe(1);
    expect(results3.map((r) => r.id)).toEqual(['str-1']);
    ...
    expect(results4.map((r) => r.id)).toEqual(['str-1']);
    ...
    expect(results5.map((r) => r.id)).toEqual(['str-2', 'str-3', 'str-4', 'str-5']);
    ...
    expect(results6.map((r) => r.id)).toEqual(['str-3', 'str-4', 'str-5']);
    ...
    expect(results7.map((r) => r.id)).toEqual(['str-1', 'str-2']);
  });
  ...
  it('should handle string not operation', async () => {
    ...
    const results = await prisma.$queryRaw<Array<{ id: string }>>(query);
    expect(results.length).toBe(4);
    expect(results.map((r) => r.id)).toEqual(['str-2', 'str-3', 'str-4', 'str-5']);
  });
  ...
  it('should handle string search operation', async () => {
    ...
    expect(results1.map((r) => r.id)).toEqual(['str-1', 'str-2', 'str-4']);
    ...
    expect(results2.map((r) => r.id)).toEqual(['str-1', 'str-3', 'str-4']);
    ...
    expect(results3.map((r) => r.id)).toEqual(['str-1', 'str-4']);
    ...
    expect(results4.map((r) => r.id)).toEqual(['str-1', 'str-4']);
    ...
    expect(results5.map((r) => r.id)).toEqual(['str-1', 'str-4']);
    ...
    expect(results6.map((r) => r.id)).toEqual(['str-1', 'str-4']);
  });
});
